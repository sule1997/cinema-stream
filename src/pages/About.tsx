    ...
    <div className="min-h-screen bg-background mobile-container">
      ...
      <div className="p-4 space-y-6 pb-24">
        ...
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold">Dirajumla</h2>
        ...
        <Card className="bg-card">
          <CardContent className="p-4 space-y-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Dirajumla is dedicated to bringing you the best entertainment experience. 
        ...
        <div className="space-y-3">
          <h3 className="font-semibold text-lg">Why Choose Dirajumla?</h3>
        ...
        <Card className="bg-card">
          <CardContent className="p-4 space-y-3 text-center">
            ...
            <p className="text-sm text-primary">support@Dirajumla.app</p>
          </CardContent>
        </Card>

        <p className="text-center text-xs text-muted-foreground">
          © {new Date().getFullYear()} Dirajumla. All rights reserved.
        </p>
      </div>
    </div>
  );
